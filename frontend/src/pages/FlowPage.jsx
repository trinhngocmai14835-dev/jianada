...
const MODE_COLOR = {
  rushbet: 'volcano', followbet: 'green', rotatebet: 'purple', custom_rotatebet: 'magenta', random_rotatebet: 'blue', custom_winbet: 'gold', four_code_winbet: 'lime', main_trend_bet: 'cyan',
}
