...
export const api = {
  ...
  getRandomRotateBetConfig: () => req('GET', '/config/random-rotatebet'),
  saveRandomRotateBetConfig: (data) => req('POST', '/config/random-rotatebet', data),
  ...
  startRandomRotateBet: () => req('POST', '/random-rotatebet/start'),
  stopRandomRotateBet: () => req('POST', '/random-rotatebet/stop'),
  getRandomRotateBetAccountStatuses: () => req('GET', '/random-rotatebet/accounts/status'),
  stopRandomRotateBetAccount: (key) => req('POST', '/random-rotatebet/accounts/stop', { key }),
